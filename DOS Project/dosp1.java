...
public class dosp1 {
    public static void main (String [] args) {
        ...
        while (true) {
            ...
            System.out.println("2. Round Robin (RR)"); System.out.println("3. Terminate                      Program");
    ...
    static void findAvgTime(int processes [], int n, int burstTimes[], int quantum, int arrivalTimes[]) {
        int wt[] = new int[n];
        int tat[] = new int[n];
        int ct[] = new int[n];
        int rt[] = new int[n];
    ...
    static double calculateFCFSAvgWaitingTime( int [] burstTimes,int [] arrivalTimes) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            ct[i] = prevCT + burstTimes[i]; prevCT = ct[i];
        }
        double total_wt = 0;
        for (int i = 0; i < n; i++) {
            total_wt += wt[i];
